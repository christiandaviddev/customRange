(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-fixed-values-range-fixed-values-range-module~components-normal-range-normal-range-module"], {
    ...
    /***/
    function dRiO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FilterProductsService", function () {
      ...
      var FilterProductsService = /*#__PURE__*/function () {
        function FilterProductsService(http) {
          _classCallCheck(this, FilterProductsService);

          this.http = http;
        }

        _createClass(FilterProductsService, [{
          key: "getPricesMinMax",
          value: function getPricesMinMax() {
            return this.http.get('https://demo3474271.mockable.io/pricesProductsMinMax');
          }
        }, {
          key: "getPricesValues",
          value: function getPricesValues() {
      ...
      FilterProductsService.ɵfac = function FilterProductsService_Factory(t) {
        return new (t || FilterProductsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
      };

      FilterProductsService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: FilterProductsService,
        factory: FilterProductsService.ɵfac,
        providedIn: 'root'
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FilterProductsService, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
          args: [{
            providedIn: 'root'
          }]
    ...
    function j8Zf(module, __webpack_exports__, __webpack_require__) {
      ...
      var RangeComponent = /*#__PURE__*/function () {
        function RangeComponent() {
          ...
          */
          ...
          this.rangeSubscriptions = []; // isMouseDownEvent: boolean;
        ...
        _createClass(RangeComponent, [{
          ...
          value: function setRangePointByClick(positionX) {
            var mousePosition = this.getMousePosition(positionX);
            var valueForFilter = this.getValueForFilter(mousePosition, this.maxPrice);
            this.processNewPosition(mousePosition, valueForFilter);
            var resultRange = {
              left: this.leftPrice,
              right: this.rightPrice
            };
            this.onTouch();
            this.onChange(resultRange); // TODO: If there is not any ngModule input provided, a rangeChange output has to emit range values.

            this.rangeChange.emit(resultRange);
          }
        }, {
          key: "getMousePosition",
          value: function getMousePosition(mousePosition) {
          ...
          value: function getValueForFilter(mousePosition, maxPrice) {
            var value = maxPrice * (mousePosition / 2 / 100);
            value = value >= maxPrice ? maxPrice : value;
            return value;
          }
        }, {
          key: "processNewPosition",
          value: function processNewPosition(mousePosition, bulletPrice) {
            var newBulletPosition = mousePosition - this.leftBullet.offsetWidth;
            var differenceFromLeft = this.getDifference(newBulletPosition, this.leftBulletPosition);
            newBulletPosition = mousePosition - this.rightBullet.offsetWidth;
            var differenceFromRight = this.getDifference(newBulletPosition, this.rightBulletPosition);
          ...
          key: "getDifference",
          value: function getDifference(positionA, positionB) {
            positionA = positionA - positionB;
            return positionA < 0 ? positionA * -1 : positionA;
          }
        }, {
          key: "mouseDownEvent",
          value: function mouseDownEvent(evnt) {// TODO: dragg bullet
          ...
          key: "leftBulletPosition",
          get: function get() {
            var position = this.leftBullet.style.left.replace('px', '');
          ...
          key: "rightBulletPosition",
          get: function get() {
            var position = this.rightBullet.style.left.replace('px', '');
            return Number(position);
          },
          set: function set(v) {
      ...
      RangeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 11,
        vars: 4,
        consts: [["id", "range-container"], [1, "input-filed", 3, "disabled", "ngModel", "ngModelChange"], ["min", ""], ["id", "range-box"], ["id", "range-line", 1, "range-line", 3, "click"], ["id", "left-range-bullet", 1, "range-bullet", 3, "mousedown"], ["leftBullet", ""], ["id", "right-range-bullet", 1, "range-bullet", 3, "mousedown"], ["rightBullet", ""], ["max", ""]],
        template: function RangeComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RangeComponent_Template_input_ngModelChange_1_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RangeComponent_Template_p_click_4_listener($event) {
              return ctx.setRangePointByClick($event == null ? null : $event.pageX);
            });

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "span", 5, 6);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mousedown", function RangeComponent_Template_span_mousedown_5_listener($event) {
              return ctx.mouseDownEvent($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mousedown", function RangeComponent_Template_span_mousedown_7_listener($event) {
              return ctx.mouseDownEvent($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RangeComponent_Template_input_ngModelChange_9_listener($event) {
