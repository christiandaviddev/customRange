...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _components_range_range_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/range/range.component */ "j8Zf");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SharedModule, { declarations: [_components_range_range_component__WEBPACK_IMPORTED_MODULE_2__["RangeComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"]], exports: [_components_range_range_component__WEBPACK_IMPORTED_MODULE_2__["RangeComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SharedModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
                declarations: [
                    _components_range_range_component__WEBPACK_IMPORTED_MODULE_2__["RangeComponent"]
                ],
                imports: [
                    _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                    _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"]
...
/***/ "dRiO":
/*!*********************************************************************!*\
  !*** ./src/app/services/filter-products/filter-products.service.ts ***!
  \*********************************************************************/
/*! exports provided: FilterProductsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilterProductsService", function() { return FilterProductsService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
FilterProductsService.ɵfac = function FilterProductsService_Factory(t) { return new (t || FilterProductsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
FilterProductsService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: FilterProductsService, factory: FilterProductsService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FilterProductsService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
class RangeComponent {
    ...
    ngOnInit() {
        this.rangeLine = document.getElementById('range-line');
        this.leftBullet = document.getElementById('left-range-bullet');
        this.rightBullet = document.getElementById('right-range-bullet');
        this.leftBulletPosition = 0;
        this.rightBulletPosition = this.rangeLine.offsetWidth;
    }
    ngOnDestroy() {
        this.rangeSubscriptions.forEach((s) => s.unsubscribe());
    }
    setRangePointByClick(positionX) {
        const mousePosition = this.getMousePosition(positionX);
        const valueForFilter = this.getValueForFilter(mousePosition, this.maxPrice);
        this.processNewPosition(mousePosition, valueForFilter);
        const resultRange = { left: this.leftPrice, right: this.rightPrice };
        this.onTouch();
    ...
    getValueForFilter(mousePosition, maxPrice) {
        let value = maxPrice * ((mousePosition / 2) / 100);
        value = value >= maxPrice ? maxPrice : value;
        return value;
    }
    processNewPosition(mousePosition, bulletPrice) {
    ...
    getDifference(positionA, positionB) {
    ...
    // }
    get leftBulletPosition() {
        const position = this.leftBullet.style.left.replace('px', '');
        return Number(position);
    }
    set leftBulletPosition(v) {
        this.leftBullet.style.left = String(v) + 'px';
    }
    get rightBulletPosition() {
        const position = this.rightBullet.style.left.replace('px', '');
        return Number(position);
    }
    set rightBulletPosition(v) {
        this.rightBullet.style.left = String(v) + 'px';
    }
}
RangeComponent.ɵfac = function RangeComponent_Factory(t) { return new (t || RangeComponent)(); };
RangeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RangeComponent, selectors: [["ngc-range"]], inputs: { minPrice: ["min", "minPrice"], maxPrice: ["max", "maxPrice"], values: "values", type: "type" }, outputs: { rangeChange: "rangeChange" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([
            {
                provide: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NG_VALUE_ACCESSOR"],
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(() => RangeComponent),
                multi: true
            }
        ])], decls: 11, vars: 4, consts: [["id", "range-container"], [1, "input-filed", 3, "disabled", "ngModel", "ngModelChange"], ["min", ""], ["id", "range-box"], ["id", "range-line", 1, "range-line", 3, "click"], ["id", "left-range-bullet", 1, "range-bullet", 3, "mousedown"], ["leftBullet", ""], ["id", "right-range-bullet", 1, "range-bullet", 3, "mousedown"], ["rightBullet", ""], ["max", ""]], template: function RangeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "input", 1, 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RangeComponent_Template_input_ngModelChange_1_listener($event) { return ctx.minPrice = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "p", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RangeComponent_Template_p_click_4_listener($event) { return ctx.setRangePointByClick($event == null ? null : $event.pageX); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "span", 5, 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mousedown", function RangeComponent_Template_span_mousedown_5_listener($event) { return ctx.mouseDownEvent($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "span", 7, 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mousedown", function RangeComponent_Template_span_mousedown_7_listener($event) { return ctx.mouseDownEvent($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](9, "input", 1, 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RangeComponent_Template_input_ngModelChange_9_listener($event) { return ctx.maxPrice = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("disabled", ctx.type === "fixed")("ngModel", ctx.minPrice);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](8);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("disabled", ctx.type === "fixed")("ngModel", ctx.maxPrice);
    } }, directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgModel"]], styles: ["#range-box[_ngcontent-%COMP%] {\n  position: relative;\n  display: flex;\n  width: 200px;\n  height: 10px;\n  align-items: center;\n}\n\n.input-filed[_ngcontent-%COMP%] {\n  margin: 3% 0%;\n  width: 50px;\n}\n\n#range-line[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 3px;\n  background-color: blue;\n  cursor: pointer;\n}\n\n.range-bullet[_ngcontent-%COMP%]:hover {\n  height: 13px;\n  width: 13px;\n  cursor: move;\n}\n\n.range-bullet[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 50%;\n  width: 10px;\n  height: 10px;\n  border-radius: 50%;\n  cursor: pointer;\n  transform: translateY(-50%);\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  background-color: blue;\n}\n\n#left-range-bullet[_ngcontent-%COMP%]:hover {\n  background-color: red;\n}\n\n#right-range-bullet[_ngcontent-%COMP%]:hover {\n  background-color: green;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RangeComponent, [{
...
//# sourceMappingURL=default~components-fixed-values-range-fixed-values-range-module~components-normal-range-normal-range-module-es2015.js.map