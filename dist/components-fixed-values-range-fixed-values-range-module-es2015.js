...
class FixedValuesRangeComponent {
    ...
    getPriceValues() {
        this.filterProductsService.getPricesValues().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(prices => { var _a; return this.values = (_a = prices === null || prices === void 0 ? void 0 : prices.values) !== null && _a !== void 0 ? _a : []; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])((err) => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(err))).subscribe();
    }
}
FixedValuesRangeComponent.ɵfac = function FixedValuesRangeComponent_Factory(t) { return new (t || FixedValuesRangeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_filter_products_filter_products_service__WEBPACK_IMPORTED_MODULE_3__["FilterProductsService"])); };
FixedValuesRangeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FixedValuesRangeComponent, selectors: [["ngc-fixed-values-range"]], decls: 7, vars: 6, consts: [["name", "range", 3, "values", "type", "ngModel", "ngModelChange"]], template: function FixedValuesRangeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function FixedValuesRangeComponent_Template_ngc_range_ngModelChange_3_listener($event) { return ctx.rangeValues = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
